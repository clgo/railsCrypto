class CryptosController < ApplicationController
  ...
  before_action :correct_user, only: [:edit, :update, :destory, :show]
  
  # GET /cryptos
  # GET /cryptos.json
  def index
    @cryptos = Crypto.all
    #@datatable = CryptosDatatable.new(self)
    require 'net/http'
    require 'json'
  ...
  private
    ...
    def crypto_params
      params.require(:crypto).permit(:symbol, :user_id, :cost_per, :amount_owned, :date_purchased)
    end
    
    # define a correct_user method
    def correct_user
